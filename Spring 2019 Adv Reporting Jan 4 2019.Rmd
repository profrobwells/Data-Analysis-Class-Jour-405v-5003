...
**Agenda**
      ...
      2) Updated R software. Open and run scripts
      
      3) Sign up for a census key:
      https://api.census.gov/data/key_signup.html

      4) What is an API?
      
      5) Video of Machlis mapping  
...
##Wednesday March 27  
      ...
      In-Class Assignment: Andrew Ba Tran - Mapping    
      http://learn.r-journalism.com/en/mapping/ 
...
Repo for Andrew Ba Tran mapping exerices:
      install.packages("usethis")
...
#Week #13:  Web Scraping in R, GitHub, RMarkdown 
...
**Agenda**
--Wednesday 3/13/2019: R Markdown 
