...
> [**Syllabus - Jour 405v:**: "CNTL" + click for a New Tab](http://bit.do/Jour405v_syllabus){target="_blank"}



> [**Syllabus - Jour 5003**: "CNTL" + click for a New Tab](http://bit.do/Jour5003_syllabus){target="_blank"}   

> [**Course Website**: "CNTL" + click for a New Tab](https://github.com/profrobwells/Data-Analysis-Class-Jour-405v-5003){target="_blank"}   
...
#Week #5: Dplyr - Using R to build basic graphs and charts  
...
--Dplyr bootcamp. See this exercise: DPLYR_bootcamp_Feb_9   
