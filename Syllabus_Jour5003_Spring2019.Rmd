---
title: "Jour 5003 Inside Twitter: Data Analysis for Journalists"
date: "1/11/2019"
output: html_document
---

###Jour 5003, Sec. 7, Spring 2019
...
This course is co-taught with an undergraduate section, Jour 405v, Sec. 7. Graduate students will study similar material but will have additional readings, an extra assignment and additional tasks in their assignments above the workload for the undergraduate students.
...
Students will use R Studio to gather, analyze and visualize U.S. Census data for Arkansas. 
They will produce graphics on median household income; income by women-led households; income by latino-based households; income by black-led households. Compare to state and national averages. Data dictionary required
...
###Extra Grad Assignment - Essay on Data. Due March 13     
A 1,000-word essay based on a Nick Diakopolous online class to explore some of the theoretical and conceptual issues raised about algorithmic journalism. You will be asked to write on four questions, one from each of the modules. 
...
Students will use R Studio to extract a corpus of Twitter data, manage that data in R and produce a basic interactive visualization. 
